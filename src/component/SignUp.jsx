        ...
        <div className="p-8">
          ...
          <div className="flex flex-col items-center gap-3 mb-4">
            <div className="flex items-center gap-3">
              <MdOutlineBloodtype className='text-red-600 text-4xl'/>
              <h1 className="text-2xl font-semibold text-gray-800">LifeLink</h1>
            </div>
            <h2 className="text-xl font-medium text-gray-700">Create Account</h2>
            <p className="text-sm text-gray-500 text-center">
              Sign up to start helping save lives
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Submit Button */}
            <button type="submit"
              className="w-full bg-red-600 hover:bg-red-700 text-white rounded-lg py-3 font-medium shadow-sm transition">
              Sign Up
            </button>
          </form>
          ...
          <div className="mt-5 text-center text-sm text-gray-600">
            <p>
              ...
              <Link to="/login" className="text-red-600 font-medium underline">
                Login here
              </Link>
            </p>
